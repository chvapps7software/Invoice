...
export const WebsiteTemplate = ({ data, subtotal, total }: { data: any, subtotal: number, total: number }) => {
	return (
		<div className="font-sans text-sm text-gray-800">
			{/* 1. PDF-Friendly Header (No Flexbox) */}
			<div className="text-center p-2 bg-gray-100 border-b">
				<p>{data.companyPhone} | {data.companyEmail}</p>
			</div>

			{/* 2. PDF-Friendly Title Section (Use Grid) */}
			<div className="grid grid-cols-2 items-center my-8 px-8">
				<div>
				...
				<div className="text-right">
					<h2 className="text-4xl font-bold">PRICE QUOTATION</h2>
					...
					<table className="w-full">
						<tbody>
							...
							<tr className="font-bold text-lg bg-gray-100">
								...
								<td className="text-right p-3">₹{total.toLocaleString('en-IN')}</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div className="px-8 mt-10">
				<h3 className="font-bold text-lg mb-2 border-b pb-1">Terms & Conditions</h3>
			...
			<footer className="mt-12 text-center text-xs text-gray-500 border-t pt-4 no-print-footer">
